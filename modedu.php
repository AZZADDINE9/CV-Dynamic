...
<!--     ce fichier permet de modifie une information de section EDUCATION         -->
<?php include 'connection.php';?>
  <?php    if(isset($_GET['modedu'])){
  $modifier_edu=$_GET['modedu'];
...
if(isset($_POST['modedu'])){
$d=$_POST['Da'];
$e=$_POST['edu'];


$sql= "UPDATE `cv`.`education` SET `Date` = '$d', `education` = '$e' WHERE `education`.`id` = $modifier_edu";
...
echo "bien";
       ...
       $sql="SELECT * FROM `education` WHERE id=$modifier_edu";
          $result = mysqli_query($conn, $sql);
           $row = mysqli_fetch_assoc($result);?>

           <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-edit fa-fw w3-margin-right w3-xxlarge w3-text-orange"></i>update Education</h2>
  ...
  <input class="w3-input w3-border" name="edu" type="text" value="<?php
   echo $row['education'];?>"></p>
       
  <button class="w3-btn w3-orange" name='modedu'>Modifeir</button></p>
</form>
      </div>
