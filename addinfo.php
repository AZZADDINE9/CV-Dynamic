<!--     ce fichier permet de ajouter une information de section INFORMATION PERSONNELLE         -->
...
$sql= "INSERT INTO `info_pesonnelle` (`id`, `info`) VALUES (NULL, '$aa')";
...
echo "bien";
        ...
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-blue"></i>ADD Information personnelle</h2>
  ...
  <p>      
  <label class="w3-text-blue"><b>add un information personelle</b></label>
  <input class="w3-input w3-border" name="nname" type="text"></p>
  <p>      
  <button class="w3-btn w3-blue" name='addinfo'>Ajouter</button></p>
</form>
      </div>
