...
echo "bien";
        ...
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-blue"></i>ADD SKILLS</h2>
  ...
  <p>      
  <button class="w3-btn w3-blue" name='addskill'>Ajouter</button></p>
</form>
      </div>
