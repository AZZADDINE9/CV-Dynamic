<!--     ce fichier permet de ajouter une information de section EXPERINECE        -->
...
$sql= "INSERT INTO `experience` (`id`, `date`,`experience`) VALUES (NULL, '$d','$e')";
...
echo "bien";
        ...
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-blue"></i>ADD Experience </h2>
  ...
  <p>  
  <p>      
  <label class="w3-text-blue"><b>ajouter un experience</b></label>
  <input class="w3-input w3-border" name="EXP" type="text"></p>
  <p>      
  <button class="w3-btn w3-blue" name='addexp'>Ajouter</button></p>
</form>
      </div>
