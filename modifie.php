<!--     ce fichier permet de modifie une information de section SKILLS         -->
...
if(isset($_POST['modskill'])){
$a=$_POST['nname'];

$b=$_POST['level'] ;
$sql= "UPDATE `cv`.`skills` SET `nonSK` = '$a', `levelSK` = '$b' WHERE `skills`.`id` = $modifier";
...
echo "bien";
       ...
       $sql="SELECT * FROM `skills` WHERE id=$modifier";
          $result = mysqli_query($conn, $sql);
           $row = mysqli_fetch_assoc($result);?>

           <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-edit fa-fw w3-margin-right w3-xxlarge w3-text-orange"></i>update SKILLS</h2>
  ...
  <input class="w3-input w3-border" name="level" value="<?php echo $row['levelSK'];?>"type="number"></p>
  <p>      
  <button class="w3-btn w3-orange" name='modskill'>Modifeir</button></p>
</form>
      </div>
